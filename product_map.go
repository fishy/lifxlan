...
var ProductMap = map[uint64]Product{
	...
	ProductMapKey(1, 125): {
		VendorName:  "LIFX",
		VendorID:    1,
		ProductName: "LIFX White to Warm US",
		ProductID:   125,
		Features: Features{
			HEV:               OptionalBoolPtr(false),
			Color:             OptionalBoolPtr(false),
	...
	ProductMapKey(1, 126): {
		VendorName:  "LIFX",
		VendorID:    1,
		ProductName: "LIFX White to Warm Intl",
		ProductID:   126,
		Features: Features{
			HEV:               OptionalBoolPtr(false),
			Color:             OptionalBoolPtr(false),
	...
	ProductMapKey(1, 135): {
		VendorName:  "LIFX",
		VendorID:    1,
		ProductName: "LIFX GU10 Color US",
		ProductID:   135,
		Features: Features{
			HEV:               OptionalBoolPtr(false),
			Color:             OptionalBoolPtr(true),
	...
	ProductMapKey(1, 136): {
		VendorName:  "LIFX",
		VendorID:    1,
		ProductName: "LIFX GU10 Color Intl",
		ProductID:   136,
		Features: Features{
			HEV:               OptionalBoolPtr(false),
			Color:             OptionalBoolPtr(true),
	...
	ProductMapKey(1, 137): {
		VendorName:  "LIFX",
		VendorID:    1,
		ProductName: "LIFX Candle Color US",
		ProductID:   137,
		Features: Features{
			HEV:               OptionalBoolPtr(false),
			Color:             OptionalBoolPtr(true),
	...
	ProductMapKey(1, 138): {
		VendorName:  "LIFX",
		VendorID:    1,
		ProductName: "LIFX Candle Color Intl",
		ProductID:   138,
		Features: Features{
			HEV:               OptionalBoolPtr(false),
			Color:             OptionalBoolPtr(true),
